{
  ...
  "limits": {
    ...
    "mmt_target_grade": {
      "bilateral_ankle_dorsiflexors": "3-/5"
    },
    "collision_override": {
      "enable": true,
      "region": "lumbar"
...
| Motion            | Normal Approx.                | Actual                | Notes                                             |
| ----------------- | ----------------------------- | --------------------- | ------------------------------------------------- |
| Lumbar Flexion    | 60°+ (fingers to ankles/toes) | **20°** (severe pain) | Guarded, very stiff, pain unchanged by repetition |
| Lumbar Extension  | 25°                           | **5°** (severe pain)  | Marked limitation                                 |
| Lateral Flexion R | 25°                           | 15°                   | Mild loss, pain central                           |
| Lateral Flexion L | 25°                           | 15°                   | Mild loss, pain central                           |
...
### MMT (Lower Extremity Key Groups)

| Muscle Group / Test                | Right Strength | Left Strength | Notes                                 |
| ---------------------------------- | -------------- | ------------- | ------------------------------------- |
| Hip Flexors                        | 4-/5           | 4-/5          | Pain in back, but can resist mildly   |
| Knee Extensors (Quadriceps)        | 4/5            | 4/5           | Slightly reduced, symmetrical         |
| Ankle Dorsiflexors (Tibialis Ant.) | **3-/5**       | **3-/5**      | Bilateral weakness, “feet feel heavy” |
| Ankle Plantarflexors               | 4-/5           | 4-/5          | Slight weakness, symmetric            |
